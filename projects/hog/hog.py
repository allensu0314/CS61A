...
def free_bacon(opponent_score):
    ...
    while opponent_score:
        opponent_score, n = opponent_score // 10, opponent_score % 10
        if res < n:
            res = n
    return res + 1
    # END PROBLEM 2
...
# This current implementation is too redundancy
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while True:
        if player == 0:
            ...
            # Pig Out\Free Bacon\Hogtimus Prime\When Pigs Fly\Hog Wild #
